...
const Register = () => {
  return (
    <div className="max-w-md m-auto p-4 sm:p-6 flex flex-col bg-gradient-to-bl from-[#E8DFFF] to-[#DDEBFF] rounded-lg shadow-lg">
      ...
      <div className="my-5">
        <button
          type="button"
          className="w-full inline-flex items-center justify-center py-2 px-4 mb-7 rounded-md text-sm font-medium
          bg-gradient-to-bl from-[#E8DFFF]/30 to-[#DDEBFF]/30
          shadow-xl shadow-black/10 border border-white/50 group-hover:shadow-lg group-hover:scale-95 transition-all"
        >
          <svg
            className="w-5 h-5"
      ...
      <div className="flex flex-col gap-4">
        <div>
          <label className="block text-sm sm:text-base leading-snug text-[#334155] mb-1">
